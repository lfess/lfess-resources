```
This template is to be used for building a spec. Please remove any code sections like this before publishing.

Specifications are recommended to be drafted in accordance with international best practices.  Doing so provides clarity, helps adoption, and also eases the transition of this specification to other standards body if so desired.  Accordingly, the recommended template below is based on ISO standard drafting conventions.
...
Version: _SPEC VERSION_

Status: `one of Pre-draft, Draft, Approved`
